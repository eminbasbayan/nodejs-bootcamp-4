...
const register = asyncHandler(async (req, res, next) => {
  ...
  res.status(201).json(new ApiResponse(201, 'Kayıt başarılı', {
    user,
    tokens: {
      accessToken,
      refreshToken
...
const login = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json(new ApiResponse(200, 'Giriş başarılı', {
    user,
    tokens: {
      accessToken,
      refreshToken
...
const refresh = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    res.status(200).json(new ApiResponse(200, 'Token yenilendi', {
